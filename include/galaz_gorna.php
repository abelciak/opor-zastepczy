<div id="pokazg1[<?=$idGalaz;?>]" style="display:block;"  onclick="document.getElementById('pokazg2[<?=$idGalaz;?>]').style.display='block';document.getElementById('pokazg1[<?=$idGalaz;?>]').style.display='none';">
	<font color='purple'><b>Kliknij tutaj aby dodać podgałąź <u>górną</u></b></font>
</div>

<div id="pokazg2[<?=$idGalaz;?>]" style="display:none;">
		


<table border='1'>
<tr><td colspan='2'><center><h2><font color='darkblue'><b>Dodaj podgałaź górną</b></font></h2></center></td></tr>		
...
<INPUT type="hidden" NAME="aktualnagalaz" VALUE="<?=$idGalaz;?>">
<INPUT type="hidden" NAME="polaczenieg" VALUE="szereg">
<INPUT type="hidden" NAME="wybormiejsce" VALUE="gora">
...
<div onclick="document.getElementById('pokazg1[<?=$idGalaz;?>]').style.display='block';document.getElementById('pokazg2[<?=$idGalaz;?>]').style.display='none';">
		<font color='red'><b>Kliknij tutaj aby zwinąć menu dodawania podgałęzi <u>górnej</u></b></font>
	</div>
</div>