<div id="pokazsz1[<?=$idGalaz;?>]" style="display:block;"  onclick="document.getElementById('pokazsz2[<?=$idGalaz;?>]').style.display='block';document.getElementById('pokazsz1[<?=$idGalaz;?>]').style.display='none';">
	<font color='purple'><b>Kliknij tutaj aby dodać podgałąź</b></font>
</div>

<div id="pokazsz2[<?=$idGalaz;?>]" style="display:none;">
		


<table border='1'>
<tr><td colspan='2'><center><h2><font color='darkblue'><b>Dodaj podgałaź</b></font></h2></center></td></tr>		
...
<div onclick="document.getElementById('pokazsz1[<?=$idGalaz;?>]').style.display='block';document.getElementById('pokazsz2[<?=$idGalaz;?>]').style.display='none';">
		<font color='red'><b>Kliknij tutaj aby zwinąć menu dodawania podgałęzi</b></font>
	</div>
</div>